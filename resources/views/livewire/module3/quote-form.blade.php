...
<style>
    ...
    .totals-row.ttc { font-size: 16px; font-weight: 800; color: #6366f1; border-top: 1px dashed var(--border-color); padding-top: 10px; margin-top: 6px; }
...
<form wire:submit.prevent="save">
    ...
    <div class="form-section">
        <div class="form-section-header">
            <span class="sec-icon indigo"><i class="bi bi-info-circle"></i></span>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-3">
                    <div class="fg">
                        ...
                        <input type="date" wire:model="valid_until" class="fc">
                        <div class="validity-hint"><i class="bi bi-clock"></i> Date limite d'acceptation par le client</div>
                        @error('valid_until')<div class="field-error"><i class="bi bi-exclamation-circle"></i>{{ $message }}</div>@enderror
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="fg">
