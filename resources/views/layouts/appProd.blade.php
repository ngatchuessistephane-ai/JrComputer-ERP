...
<body data-user-role="{{ auth()->user()->getRoleNames()->first() }}" data-user-id="{{ auth()->id() }}">
    ...
    <div class="main-content" id="mainContent">
        <header class="topbar">
            ...
            <div class="topbar-title" id="pageTitle">
                @php
                    $hour = now()->hour;
                    $greeting = $hour >= 5 && $hour < 12 ? 'Bonjour' 
                    : ($hour >= 12 && $hour < 18 ? 'Bon après-midi' 
                    : ($hour >= 18 && $hour < 22 ? 'Bonsoir' : 'Bonne nuit'));
                @endphp
    ...
    <button class="np-icon-btn" id="refreshNotifBtn" title="Actualiser">
        <i class="bi bi-arrow-repeat" id="npRefreshIcon"></i>
                        ...
                        <!-- <div class="np-footer">
                            <button class="np-footer-btn" id="viewAllNotifBtn">
                                Voir toutes les notifications <i class="bi bi-arrow-right" style="font-size:10px;"></i>
                            </button>
                        </div> -->
                    </div>
                </div>
